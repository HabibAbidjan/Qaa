...
@bot.message_handler(func=lambda m: m.text == "🎲 Play Dice") def play_dice(message): user_id = message.from_user.id if user_balances.get(user_id, 0) < 1000: bot.send_message(user_id, "❌ Kamida 1000 so‘m kerak.") return
